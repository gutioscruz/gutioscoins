...
const Budget = () => {
  ...
  // Análise histórica dos últimos 3 meses
  ...
  // Projeção de orçamento com base na média histórica
  ...
  const totalVariance = totalCurrent - totalEstimated;
  const totalVariancePercentage = totalEstimated > 0 ? (totalVariance / totalEstimated) * 100 : 0;
        ...
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-muted-foreground mt-1">
              Análise baseada nos últimos 3 meses
            </p>
          </div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="flex items-center gap-2">
                ...
                <p className={`text-3xl font-bold ${totalVariance >= 0 ? 'text-destructive' : 'text-income'}`}>
